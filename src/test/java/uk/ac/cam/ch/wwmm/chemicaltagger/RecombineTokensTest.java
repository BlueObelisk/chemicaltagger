...
public class RecombineTokensTest {
	...
	public void testRecombineSentence1() {
		...
		posContainer.registerTagList(oscarTagger.runTagger(posContainer.getWordTokenList(), null));
		posContainer.registerTagList(regexTagger.runTagger(posContainer.getWordTokenList(), null));
		posContainer.registerTagList(openNLPTagger.runTagger(posContainer.getWordTokenList(), null));
